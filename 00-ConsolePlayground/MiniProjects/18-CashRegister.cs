// Reference material: https://learn.microsoft.com/en-us/training/modules/guided-project-debug-handle-exceptions-c-sharp-console-application/2-prepare
namespace MiniProjects.CashRegister
{
    class CashRegister
    {
        /*
